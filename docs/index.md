...
| Score in OpenBB Workspace | {doc}`getting-started/quickstart-openbb` |
...
- **Multiple surfaces** — terminal CLI, Python imports, REST API, OpenBB Workspace, and MCP tools for agents
